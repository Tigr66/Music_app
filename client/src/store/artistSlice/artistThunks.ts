...
export const addArtistThunk = createAsyncThunk<
    ...
    FormData,
    { rejectValue: string }
>("artist-slice/add-artist", async (data, { rejectWithValue }) => {
    try {
...
export const getArtistsThunk = createAsyncThunk<
    ...
    void,
    { rejectValue: string }
>("artist-slice/get-artists", async (_, { rejectWithValue }) => {
    try {
...
export const getArtistByIdThunk = createAsyncThunk<
    ...
    string,
    { rejectValue: string }
>("artist-slice/get-artist-by-id", async (artistId, { rejectWithValue }) => {
    try {
...
export const publishArtistThunk = createAsyncThunk<
    ...
    string,
    { rejectValue: string }
>("artist-slice/publish-artist", async (artistId, { rejectWithValue }) => {
    try {
...
export const deleteArtistThunk = createAsyncThunk<
    ...
    string,
    { rejectValue: string }
>("artist-slice/delete-artist", async (artistId, { rejectWithValue }) => {
    try {
